...
class Command(BaseCommand):
    ...
    def add_arguments(self, parser):
        parser.add_argument('--count', type=int, default=100, help='Number of teachers to generate')
    ...
    def handle(self, *args, **options):
        ...
        self.stdout.write(self.style.SUCCESS(f'Successfully generated {count} teachers.'))